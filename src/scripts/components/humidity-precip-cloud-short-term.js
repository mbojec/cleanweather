...
class HumidityPrecipCloudShortTerm extends Component{
  ...
  componentDidMount() {
    ...
    let chart = am4core.create("humidity-precip-cloud-short-term", am4charts.XYChart);
    ...
    valueAxis.min = 0;
    valueAxis.max = 100;
    valueAxis.title.text = `Probability (%)`;
    ...
    series1.data = this.createPrecipData(this.props.value);
    series1.name = "Precip probability";
    ...
    series2.data = this.createHumidityData(this.props.value);
    series2.name = "Humidity";
    series2.columns.template.propertyFields.fillOpacity = "fillOpacity";
    ...
    series3.data = this.createCloudData(this.props.value);
    series3.name = "Cloud cover";

    let bullet3 = series3.bullets.push(new am4charts.CircleBullet());
    bullet3.circle.strokeWidth = 2;
    bullet3.circle.radius = 4;
    bullet3.circle.fill = am4core.color("#fffCCC");
      ...
      <>
        <div className={'card__data'}>
          ...
          <div className={'card__data__content'}>
            <div id="humidity-precip-cloud-short-term" style={{ width: "100%", height: "100%" }}></div>
          </div>
        </div>
      </>
    );
