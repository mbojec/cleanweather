    ...
    return(
      <>
        <div className={'row footer'}>
          <div className={'col-xs-8 footer__dark_sky_info'}><a href={'https://darksky.net/poweredby/'}>Powered by Dark Sky</a></div>
          <div className={'col-xs-4 footer__contact_container'}>
            <div>Contact</div>
